...
class JetAnalyzer {
    public:
        ...
        //virtual std::vector<reco::PFJet> FillRecoJetVector(const edm::Event&);
        ...
        //virtual std::map<std::string,float> RecoGenMatcher(std::vector<reco::PFJet>&, std::vector<reco::GenParticle>&, std::string);
...
//         virtual float GetResolutionErrorDown(float);
	...
	//edm::EDGetTokenT<std::vector<reco::Jet> > RecoJetToken;
