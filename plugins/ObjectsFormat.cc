...
void ObjectsFormat::FillJetType(JetType& I, const pat::Jet* R, bool isMC) {
    ...
    vector<float> pxVect(40, 0.);
    vector<float> pyVect(40, 0.);
    vector<float> pzVect(40, 0.);
    vector<float> energyVect(40, 0.);
