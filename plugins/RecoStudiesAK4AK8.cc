...
// Class:      RecoStudiesAK4AK8
// 
/**\class RecoStudiesAK4AK8 RecoStudiesAK4AK8.cc Analyzer/LongLivedReco/plugins/RecoStudiesAK4AK8.cc
...
class RecoStudiesAK4AK8 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit RecoStudiesAK4AK8(const edm::ParameterSet&);
      //RecoStudiesAK4AK8(const edm::ParameterSet&, edm::ConsumesCollector&&);
      ~RecoStudiesAK4AK8();
  ...
  long int nLooseJets, nTightJets, nJets, nLooseCHSJets, nTightCHSJets, nCHSJets, nLooseFatJets, nTightFatJets, nFatJets, nLooseCHSFatJets, nTightCHSFatJets, nCHSFatJets, nGenBquarks, nGenLL, nMatchedJets, nMatchedCHSJets;
    long int nJets_bFlav, nJets_bHadronFlav, nJets_bPartonFlav, nCHSJets_bFlav, nCHSJets_bHadronFlav, nCHSJets_bPartonFlav, nFatJets_bFlav, nCHSFatJets_bFlav;
    ...
    long int nJets_piMother, nCHSJets_piMother, number_of_b_matched_to_Jets, number_of_b_matched_to_CHSJets;
    float PUWeight;
...
//
//RecoStudiesAK4AK8::RecoStudiesAK4AK8(const edm::ParameterSet& iConfig, edm::ConsumesCollector&& CColl):
RecoStudiesAK4AK8::RecoStudiesAK4AK8(const edm::ParameterSet& iConfig):
...
RecoStudiesAK4AK8::~RecoStudiesAK4AK8()
{
...
void
RecoStudiesAK4AK8::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace edm;
    ...
    nJets = nLooseJets = nTightJets = nCHSJets = nLooseCHSJets = nTightCHSJets = nFatJets = nLooseFatJets = nTightFatJets = nCHSFatJets = nLooseCHSFatJets = nTightCHSFatJets = nGenBquarks = nGenLL = nPV = nMatchedJets = nMatchedCHSJets = 0;
    nJets_bFlav = nJets_bHadronFlav = nJets_bPartonFlav= nJets_piMother = nCHSJets_bFlav = nCHSJets_bHadronFlav = nCHSJets_bPartonFlav= nCHSJets_piMother = nFatJets_bFlav = nCHSFatJets_bFlav = number_of_b_matched_to_Jets = number_of_b_matched_to_CHSJets = 0;
	...
	*/
    ...
    theJetAnalyzer->GenMatcher(MatchedCHSJetsVect, GenBquarksVect, "q");
    //GenLongLivedVect
...
void 
RecoStudiesAK4AK8::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
RecoStudiesAK4AK8::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
bool RecoStudiesAK4AK8::isLooseJet(pat::Jet& jet){
...
bool RecoStudiesAK4AK8::isTightJet(pat::Jet& jet){
    if(fabs(jet.eta())<=2.7){/// |eta| < 2.7
...
bool RecoStudiesAK4AK8::passIDWP(std::string WP, bool isEB, float dEtaIn, float dPhiIn, float full5x5, float hoe, float d0, float dz, float ooemoop, bool conv, int missHits){
  bool pass = false;
...
DEFINE_FWK_MODULE(RecoStudiesAK4AK8);
