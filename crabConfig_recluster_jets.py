...
config.General.workArea = 'test_recluster_ak4Jets_miniaod_3May2018'#'crab_projects_LL_14feb'
...
config.JobType.psetName = 'python/recluster_ak4jets_light.py'
...
config.Data.outLFNDirBase = '/store/user/lbenato/test_recluster_ak4Jets_miniaod_3May2018'
config.Data.publication = True
config.Data.outputDatasetTag = 'test_recluster_ak4Jets_miniaod_3May2018'
